...
**Want to see the app in action?** There’s a [short screen recording](https://drive.google.com/file/d/1XzCvyhpAsM8NkrRNkocdzGMID3mJjldr/view?usp=sharing) that walks through the full application—signup, login, tasks, due dates, activity, and profile. Open the link to watch it.
